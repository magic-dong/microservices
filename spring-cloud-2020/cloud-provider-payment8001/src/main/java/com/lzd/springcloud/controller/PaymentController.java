...
public class PaymentController
{
    ...
    public CommonResult<String> create(@RequestBody Payment payment)
    {
        ...
        if(result > 0)
        {
            return new CommonResult<String>(200,"插入数据库成功,serverPort: "+serverPort,result+"");
        }else{
            return new CommonResult<String>(444,"插入数据库失败",null);
        }
    }
    ...
    {
        return "hi ,i'am payment's zipkin server fall back，welcome to lzd，O(∩_∩)O哈哈~";
    }
}
